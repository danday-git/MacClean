...
enum CleanupConfidenceTier: String, CaseIterable, Identifiable, Codable, Sendable {
    ...
    func shortDescription(for language: AppLanguage) -> String {
        ...
        case .protected:
            return isID ? "Build rilis, simbol debug, atau data integritas sistem. MacClean menjaga data ini tetap terlindungi." : "Release build, debugging symbols, or system integrity data. MacClean keeps this protected."
        }
    }
}
